...
namespace warped
{
    ...
    TimeWarpEventDispatcher::TimeWarpEventDispatcher(unsigned int max_sim_time,
                                                     ...
                                                     std::unique_ptr<TimeWarpStatistics> tw_stats) : EventDispatcher(max_sim_time), num_worker_threads_(num_worker_threads),
                                               ...
                                               std::shared_ptr<Event> restored_state_event)
    {
        ...
        // {
        //     std::cout << "Coast Forwarding Event: \n";
        //     std::cout << "Straggler" << straggler_event->timestamp() << std::endl;
        //     std::cout << "lp_id" << current_lp_id << std::endl;
        //     for (auto itr : *events)
        //     {
        //         std::cout << itr->timestamp() << " ";
        //     }
        //     std::cout << std::endl;
        // }
